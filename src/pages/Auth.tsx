      ...
      if (isLogin) {
        ...
        if (error) {
          ...
          toast({
            ...
            description: "Welcome to FinTrack. Let's set up your business.",
          });
          navigate("/dashboard");
        }
      }
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          <div className="mt-12 grid grid-cols-2 gap-6">
            <div className="p-4 rounded-xl bg-primary-foreground/10 backdrop-blur">
              <p className="text-3xl font-bold text-primary-foreground">Real-time</p>
              <p className="text-sm text-primary-foreground/70">Balance updates</p>
            </div>
            <div className="p-4 rounded-xl bg-primary-foreground/10 backdrop-blur">
              <p className="text-3xl font-bold text-primary-foreground">Instant</p>
              <p className="text-sm text-primary-foreground/70">P&L reports</p>
            </div>
          </div>
        </div>
      </div>
